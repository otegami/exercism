...
class TriangleTest < Minitest::Test
  ...
  def test_triangle_is_degenerate_if_two_sides_are_equal_to_the_other_side
    triangle = Triangle.new([2, 2, 4])
    assert triangle.degenerate?, "Expected 'true', triangle [2, 2, 4] is degenerate."
  end

  def test_triangle_is_not_degenerate_if_all_sides_are_equal
    triangle = Triangle.new([4, 4, 4])
    refute triangle.degenerate?, "Expected 'false', triangle [4, 4, 4] is not degenerate."
  end

  def test_triangle_is_not_degenerate_if_no_sides_are_equal
    triangle = Triangle.new([2, 3, 4])
    refute triangle.isosceles?, "Expected 'false', triangle [2, 3, 4] is not degenerate."
  end
end
